...
(function ($) {
    app.ModalManager = (function () {
        ...
        return function (options) {
            ...
            var _initAndShowModal = function () {
            ...
            var _open = function (args, getResultCallback) {
                ...
                _createContainer(_modalId).find('.modal-content')
                    .load(options.viewRul, _args, function (response, status, xhr) {
                        if (status == "error") {
